...
yugabyte_clusters = {
  cluster1 = {
    ...
    machine_name                    = "yb-db"
    instance_count                  = 1
    attached_disks_per_instance     = 2     # ✅ FIXED LINE
    attached_persistent_disk_sizes  = [10, 10]
...
yugabyte_control_node = {
  cluster2 = {
    ...
    attached_persistent_disk_sizes  = [10, 10]
    machine_zone                    = ["us-central1-a", "us-central1-b"]
    policy_name                     = "control-snapshot-policy"
    utc_time                        = "00:00"
    retention_days                  = 7
    storage_locations               = "us"
    enable_boot_disk                = true
    ...
    kms_key_self_link               = null
    labels                          = {}
    internal_ip                     = ["10.0.0.12","10.0.0.13",]
    region                          = "us-central1"
    machine_type                    = "n2-standard-2"
    vm_deletion_protection          = false
    network_tags                    = ["yugabyte"]
